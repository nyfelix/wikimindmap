...
<table width="100%"  border="0" cellspacing="0">
  <tr bgcolor="#C9D7F1">
    <td colspan="3" style="border-top-color:#000099"><div align="left" class="Stil2">&nbsp;
	<a href="getfreemind.php?Wiki=<?php echo $wiki; ?>&Topic=<?php echo  urlencode($topic); ?>">Download this mindmap as Freemind file</a></div></td>
  </tr>
  <tr>
    <td width="5%">&nbsp;</td>
    <td width="90%" height="400">
	        <div id="flashcontent">
                 <p>Flash plugin or Javascript are turned off.
                 Activate both  and reload to view the mindmap </p>
            </div>
        ...
        <script type="text/javascript">
				...
				function runFlash() {
					...
					fo.addVariable("initLoadFile", "getpages.php?Wiki=<?php echo $_GET['wiki']; ?>&Topic=<?php echo  urlencode($_GET['topic']); ?>");
...
<div align="center" class="Stil1 Stil8">All content of the mindmap is derived from the wiki selected above and is licensed under the terms of <a href="http://www.gnu.org/copyleft/fdl.html" target="_blank">GNU Free Documentaion Licence</a>. You can retrieve the original material by a left click on the topic.<br>
Copyright (c) 2007 by Felix Nyffenegger </div>
<p>&nbsp;</p>
<script type="text/javascript">
